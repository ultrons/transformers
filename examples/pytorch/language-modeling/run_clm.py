...
class ModelArguments:
    ...
    use_fsdp: bool = field(
        ...
        metadata={
            "help": (
                "Will use nested XLA FSDP to shard each individual transformer layer in the GPT  model."
            )
        },
    )
    ...
    use_grad_ckpt: bool = field(
        ...
        metadata={
            "help": (
                "Will use gradient checkpointing over each individual transformer layer in the GPT  model."
            )
        },
    )
